...
struct background
{
  ...
  /****** BEC condensate parameters (Landau-Ginzburg model) ******/
  
  double bec_lambda;      /**< self-interaction coefficient λ */
  double bec_g;           /**< matter coupling coefficient g */
  double bec_alpha;       /**< stabilizing quartic coefficient α */
  
  double bec_phi_ini;     /**< initial field value φ(a_ini) */
  double bec_dphi_ini;    /**< initial conformal derivative φ'(a_ini) */
  
  short has_bec;          /**< flag: _TRUE_ if BEC enabled */

  /****** V9 BEC Crust parameters (minimal vacuum substrate model) ******/
  
  double n_bec;           /**< BEC dilution exponent: Ω_BEC(z) = Ω_BEC_0 × (1+z)^n_BEC 
                              n_bec = 0 recovers ΛCDM exactly
                              n_bec ≈ 0.5 is the V9 prediction */
  short has_bec_crust;    /**< flag: _TRUE_ if V9 BEC Crust model enabled */
  ...
  /* BEC condensate indices */
  int index_bg_bec_phi;       /**< BEC field φ */
  int index_bg_bec_phi_prime; /**< BEC field derivative φ' */
  int index_bg_bec_rho;       /**< BEC energy density ρ_φ */
  int index_bg_bec_p;         /**< BEC pressure p_φ */
  int index_bg_bec_w;         /**< BEC equation of state w_φ */
  int index_bg_bec_phi_vac;   /**< BEC dynamic vacuum φ_vac = √Ω_m */

  /* V9 BEC Crust indices */
  int index_bg_rho_bec_crust; /**< V9 BEC Crust energy density */
  int index_bg_p_bec_crust;   /**< V9 BEC Crust pressure */
  int index_bg_w_bec_crust;   /**< V9 BEC Crust equation of state w = n_bec/3 - 1 */
  ...
  /* BEC condensate integration indices */
  int index_bi_bec_phi;       /**< {B} BEC field φ */
  int index_bi_bec_phi_prime; /**< {B} BEC field derivative φ' */
